...
public class MainActivity3 extends AppCompatActivity {
    ...
    public void animateEditText2() {
        ObjectAnimator animator = ObjectAnimator.ofFloat(mcq2, "translationY", -30f, 30f, -20f, 20f, 0f);
        animator.setDuration(3000);
        animator.setInterpolator(new AccelerateDecelerateInterpolator());
        animator.start();
    }
    public void animateEditText3() {
        ObjectAnimator animator = ObjectAnimator.ofFloat(mcq3, "translationX", -30f, 30f, -20f, 20f, 0f);
